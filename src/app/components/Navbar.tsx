...
const Navbar = () => {
  ...
  return (
    <header className="w-full h-25 xs:h-30">
      <nav
        className="w-full h-full sm:px-22.5 flex-col md:flex-row flex justify-between items-center bg-main-bg text-main-text relative pt-3 xs:pt-5"
        role="navigation"
      >
        ...
        <ul className="nav-links w-57.5 flex items-center justify-between text-sm xs:text-base font-normal font-roboto">
          {navLinks.map((link) => (
            <li
              key={link.id}
